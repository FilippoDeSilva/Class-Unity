...
import { role, studentsData, subjectsData } from "@/src/lib/data"
...
const Subjects = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      {/* TOP */}
    <div className='flex items-center justify-between'><h1 className="hidden md:block text-lg font-semibold">All Subject</h1>
